...
void BoundingBox::UpdateCollisionData()
{
    ...
    // OBB
    {
        // Center Position Vector Update
        {
            ...
            (
                (edge->LT.x + edge->LB.x + edge->RT.x + edge->RB.x) / 4.0f, // x
                (edge->LT.y + edge->LB.y + edge->RT.y + edge->RB.y) / 4.0f, // y
                0                                                           // z
            );
        }
        ...
        // Axis Length Update
        {
            ...
            Vector3 vericesPos[4] = { edge->LT, edge->LB, edge->RT, edge->RB };
